...
// if (dummy) {
//     dummy.forEach((data) => {
//         db.run(`INSERT INTO posts (user_id, title, published_at, status, description, thumbnail, subtitle, created_at, read_time, modified_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ? )`, [1, data.title, data.publishedAt, 'published',
